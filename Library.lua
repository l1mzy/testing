...
function DiscordLib:Window(text)
	...
	UserPanelUserIcon.MouseButton1Click:Connect(function()
		...
		ChangeBtn.BackgroundColor3 = Color3.fromRGB(109, 110, 108)
		...
		CloseBtn1.BackgroundColor3 = Color3.fromRGB(109, 110, 108)
		...
		ResetBtn.BackgroundColor3 = Color3.fromRGB(109, 110, 108)
	...
	function DiscordLib:Notification(titletext, desctext, btntext)
		...
		AlrightBtn.BackgroundColor3 = Color3.fromRGB(109, 110, 108)
	...
	function ServerHold:Server(text, img)
		...
		ServerIco.Image = "rbxassetid://12992978706"
		...
		function ChannelHold:Channel(text)
			...
			function ChannelContent:Toggle(text,default,callback)
				...
				Icon.Image = "http://www.roblox.com/asset/?id=12992978706"
				...
				Toggle.MouseButton1Click:Connect(function()
					if toggled == false then
						TweenService:Create(
							Icon,
							TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
							{ImageColor3 = Color3.fromRGB(109, 110, 108)}
						):Play()
						TweenService:Create(
							ToggleFrame,
							TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			function ChannelContent:Slider(text, min, max, start, callback)
				...
				CurrentValueFrame.BackgroundColor3 = Color3.fromRGB(109, 110, 108)
